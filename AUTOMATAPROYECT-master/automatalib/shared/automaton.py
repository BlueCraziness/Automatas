...
import automatalib.shared.exceptions as exceptions
...
class Automaton(metaclass=abc.ABCMeta):
    ...
    @abc.abstractmethod
    def _validate_input_yield_get(self, input_str):
        """Check if the given string is accepted by this automaton."""
        pass

    def _validate_input_return(self, input_str,get=False):
        """
        Check if the given string is accepted by this automaton.
        ...
        """
        if get:
            validation_generator = self._validate_input_yield_get(input_str)
    ...
    def get_state(self, input_str):
        return self._validate_input_return(input_str,get=True)
